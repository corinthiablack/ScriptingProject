...
```{r}
# gives phylogenetic signal value "K" 
# a K value >= 1 suggests that species display similar trait values to to close phylogenetic proximity
...
### Save Morphospace as a .tiff file in working directory
